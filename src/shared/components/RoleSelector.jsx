...
const RoleSelector = ({ onClose }) => {
  ...
  const handleRoleChange = async (roleId) => {
    ...
    try {
      ...
      // Manejo defensivo: la función puede no devolver objeto ni la propiedad 'success'
      if (result && typeof result === 'object') {
        if (result.success) {
          ...
          // Si no hay 'success' en el resultado, asumimos que el contexto manejó el cambio
          handleClose();
        }
      } else {
        // Fallback: cerrar el diálogo si el contexto no retorna resultado explícito
        handleClose();
      }
    } catch (error) {
